...
This is a project template for a greenfield Java project. It's named after the Java mascot _Greg_. Given below are
...
1. After that, locate the `src/main/java/Greg.java` file, right-click it, and choose `Run Greg.main()` (if the code
